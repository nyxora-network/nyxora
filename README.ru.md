...
NYXORA включает **веб-панель** для управления туннелями. Доступ: `http://YOUR_SERVER:8080/tunnel.html`

### Карта туннелей
![Карта туннелей](screenshots/01-tunnel-map.png)
*Визуальная карта соединений между серверами с анимированными линиями туннелей*

### Новое соединение
![Соединение](screenshots/02-connect.png)
*Форма создания туннельных соединений с SSH аутентификацией*

### Активные туннели
![Туннели](screenshots/03-tunnels.png)
*Список активных туннельных соединений со статусом и управлением*

### Авто-определение лучшего транспорта
![Авто-определение](screenshots/04-auto-detect.png)
*Автоматический пинг всех 14 транспортов для выбора лучшего*

### Генератор конфигов Xray
![Конфиг Xray](screenshots/05-xray-config.png)
*Генерация конфигов Xray для VLESS, VMess, Trojan, Shadowsocks*

### Установка панелей
![Панели](screenshots/06-panels.png)
*Однострочная установка Marzban, 3X-UI, Xray Core*

### Графики производительности
![Графики](screenshots/07-charts.png)
*Графики задержки, пропускной способности, потерь пакетов*

### Безопасность и аудит
![Безопасность](screenshots/08-security.png)
*Статус SSL, отпечатки серверов, неудачные входы, QoS*

### Терминал
![Терминал](screenshots/09-terminal.png)
*Полноценный интерфейс терминала с командами NYXORA*

**[Полная документация веб-панели →](web/README.md)**
