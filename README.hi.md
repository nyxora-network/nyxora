...
## 📸 वेब डैशबोर्ड स्क्रीनशॉट्स

NYXORA में टनल प्रबंधन के लिए एक **वेब डैशबोर्ड** शामिल है। एक्सेस: `http://YOUR_SERVER:8080/tunnel.html`

### टनल मैप
![टनल मैप](screenshots/01-tunnel-map.png)
*सर्वर्स के बीच कनेक्शन का दृश्य मानचित्र*

### नया कनेक्शन
![कनेक्शन](screenshots/02-connect.png)
*टनल कनेक्शन बनाने का फॉर्म*

### सक्रिय टनल्स
![टनल्स](screenshots/03-tunnels.png)
*सक्रिय टनल कनेक्शन की सूची*

### ऑटो डिटेक्ट बेस्ट ट्रांसपोर्ट
![ऑटो डिटेक्ट](screenshots/04-auto-detect.png)
*सभी 14 ट्रांसपोर्ट का स्वचालित पिंग*

### Xray कॉन्फ़िग बिल्डर
![Xray](screenshots/05-xray-config.png)
*VLESS, VMess, Trojan, Shadowsocks के लिए Xray कॉन्फ़िग*

### पैनल इंस्टॉल
![पैनल](screenshots/06-panels.png)
*Marzban, 3X-UI, Xray Core वन-क्लिक इंस्टॉल*

### परफॉर्मेंस चार्ट्स
![चार्ट्स](screenshots/07-charts.png)
*लाइव लेटेंसी, बैंडविड्थ, पैकेट लॉस चार्ट्स*

### सुरक्षा और ऑडिट
![सुरक्षा](screenshots/08-security.png)
*SSL स्टेटस, सर्वर फिंगरप्रिंट, फेल्ड लॉगिन*

### टर्मिनल
![टर्मिनल](screenshots/09-terminal.png)
*NYXORA कमांड के साथ फुल टर्मिनल*

**[पूर्ण वेब डैशबोर्ड डॉक्यूमेंटेशन →](web/README.md)**
...
**योगदान के तरीके:**
- [GitHub Issues](https://github.com/nyxora-network/nyxora/issues) पर बग रिपोर्ट करें
...
<a href="https://github.com/nyxora-network/nyxora/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nyxora-network/nyxora" alt="योगदानकर्ता" />
</a>
...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/nyxora-network/nyxora/issues">बग रिपोर्ट करें</a> •
    <a href="https://github.com/nyxora-network/nyxora/issues">सुविधा अनुरोध</a>
  </p>
  <p>
